...
def Show():
    ...
    button_image_1 = PhotoImage(
        file=r"User_UI\asset\frame0\button_1.png")
    button_1 = Button(
        image=button_image_1,
        borderwidth=0,
        highlightthickness=0,
        command=open_SidePage1,
        relief="flat",
        background='white'
    )
    button_1.place(
    ...
    button_image_2 = PhotoImage(
        file=r"User_UI\asset\frame0\button_2.png")
    button_2 = Button(
        image=button_image_2,
        borderwidth=0,
        highlightthickness=0,
        command=open_LegPage1,
        relief="flat",
        background='white'
    )
    button_2.place(
    ...
    button_image_3 = PhotoImage(
        file=r"User_UI\asset\frame0\button_3.png")
    button_3 = Button(
        image=button_image_3,
        borderwidth=0,
        highlightthickness=0,
        command=open_FootPage1,
        relief="flat",
        background='white'
    )
    button_3.place(
    ...
    image_image_1 = PhotoImage(
        file=r"User_UI\asset\frame0\image_1.png")
    ...
    button_image_4 = PhotoImage(
        file=r"User_UI\asset\frame0\button_4.png")
    button_4 = Button(
    ...
    button_image_5 = PhotoImage(
        file=r"User_UI\asset\frame0\button_5.png")
    button_5 = Button(
    ...
    button_image_6 = PhotoImage(
        file=r"User_UI\asset\frame0\button_6.png")
    button_6 = Button(
    ...
    button_image_7 = PhotoImage(
        file=r"User_UI\asset\frame0\button_7.png")
    button_7 = Button(
