...
def Show():
    ...
    image_image_1 = PhotoImage(
        file=r"User_UI\asset\frame8\image_1.png")
    ...
    button_image_1 = PhotoImage(
        file=r"User_UI\asset\frame8\button_1.png")
    button_1 = Button(
    ...
    button_image_2 = PhotoImage(
        file=r"User_UI\asset\frame8\button_2.png")
    button_2 = Button(
    ...
    button_image_3 = PhotoImage(
        file=r"User_UI\asset\frame8\button_3.png")
    button_3 = Button(
    ...
    videoplayer.load(r"User_UI\asset\frame8\2AITR_FOOT.mp4")
    ...
    button_image_4 = PhotoImage(
        file=r"User_UI\asset\frame8\button_4.png")
    button_4 = Button(
        image=button_image_4,
        borderwidth=0,
        highlightthickness=0,
        command=open_FootPageL3,
        relief="flat",
        background='white'
    )
    button_4.place(
    ...
    button_image_5 = PhotoImage(
        file=r"User_UI\asset\frame8\button_5.png")
    button_5 = Button(
