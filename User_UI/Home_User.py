...
def Show():
    ...
    image_image_1 = PhotoImage(
        file=r"User_UI\asset\frame22\image_1.png")
    ...
    image_image_2 = PhotoImage(
        file=r"User_UI\asset\frame22\image_2.png")
    ...
    button_image_1 = PhotoImage(
        file=r"User_UI\asset\frame22\button_1.png")
    button_1 = Button(
    ...
    button_image_2 = PhotoImage(
        file=r"User_UI\asset\frame22\button_2.png")
    button_2 = Button(
    ...
    button_image_3 = PhotoImage(
        file=r"User_UI\asset\frame22\button_3.png")
    button_3 = Button(
    ...
    button_image_4 = PhotoImage(
        file=r"User_UI\asset\frame22\button_4.png")
    button_4 = Button(
    ...
    button_image_5 = PhotoImage(
        file=r"User_UI\asset\frame22\button_5.png")
    button_5 = Button(
